          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-md-6 mb-6 mb-md-0">
                ...
                {t("Applatus Technology PU 4 Vijay Nagar")}
                <br />
                {t("Indore India 452001")}
                <br />
                <abbr title="Phone">{t("Phone:")}</abbr> 9111107373 
                <br />
                <abbr title="Email">{t("Email:")} </abbr>
                info@applatus.com/hello@applatus.com
                <br />
                {/* {t("Company Founders")} -{" "} */}
