...
import searchproducts from '../../jsondata/producttype/producttype.json'
import useOutsideClick from "../layout/clickoutsidehook/ClickoutsideHokk";
const Search = () => {
  ...
  return (
    <div>
      ...
      {showDropdown && filteredProducts?.length > 0 && (
        <div   ref={dropdownRef}    style={{ position: "absolute", width: "685px", zIndex: "5" }}>
                ...
                <li className="list-group-item bg-white" key={index}>
                  ...
                  >
                    <div style={{ display: "flex" }}>
                      ...
                      />
                      &nbsp; &nbsp;
                      <div onClick={(e)=>setShowDropdown(false)}>
                        <a
