            ...
            <div className="row align-items-center">
                ...
                <div className="row align-items-center">
                  <div className="col flex-horizontal-center">
                    ...
                    <h4 className="font-size-20 mb-0 ml-3">
                      Sit back and Relax & get your Apparel Delivered as per
                      your wished Design Inputs
                    </h4>
                  </div>
                </div>
              </div>
              <div className="col-lg-6 my-4 my-md-0 des">
                <h5 className="font-size-15 ml-4 mb-0">
                  Cheers! You’re happiness will be delivered shortly with
                  Korakagaj
                </h5>
              </div>
          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <p className="float-md-left font-sm text-muted mb-0">
                ...
                <strong className="text-brand"> Korakagaj</strong>
              </p>
            </div>
            {/* <div className="col-lg-6">
