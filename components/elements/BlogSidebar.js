                ...
                <div className="sidebar-widget widget_alitheme_lastpost mb-20">
                    ...
                    <div className="row">
                        <div className="col-12 sm-grid-content mb-30">
                            ...
                            <div className="post-content media-body">
                                <h4 className="post-title mb-10 text-limit-2-row">
                                    {t("The litigants on the screen are not actors")}
                                </h4>
                        ...
                        <div className="col-md-6 col-sm-6 sm-grid-content mb-30">
                            ...
                            <div className="post-content media-body">
                                <h6 className="post-title mb-10 text-limit-2-row">
                                    {t("Water Partners With Rag & Bone To Consume")}
                                </h6>
                                <div className="entry-meta meta-13 font-xxs color-grey">
                                    <span className="post-on mr-10">
                                    25{t("April")}
                        ...
                        <div className="col-md-6 col-sm-6 sm-grid-content mb-30">
                            ...
                            <div className="post-content media-body">
                                <h6 className="post-title mb-10 text-limit-2-row">
                                    {t("The loss is not all that surprising")}
                                </h6>
                                <div className="entry-meta meta-13 font-xxs color-grey">
                                    <span className="post-on mr-10">
                                    25{t("April")}
                        ...
                        <div className="col-md-6 col-sm-6 sm-grid-content mb-30">
                            ...
                            <div className="post-content media-body">
                                <h6 className="post-title mb-10 text-limit-2-row">
                                    {t("We got a right to pick a little fight, Bonanza")}
                                </h6>
                                <div className="entry-meta meta-13 font-xxs color-grey">
                                    <span className="post-on mr-10">
                                    25{t("April")}
                        ...
                        <div className="col-md-6 col-sm-6 sm-grid-content mb-30">
                            ...
                            <div className="post-content media-body">
                                <h6 className="post-title mb-10 text-limit-2-row">
                                    {t("My entrance exam was on a book of matches")}
                                </h6>
                                <div className="entry-meta meta-13 font-xxs color-grey">
                                    <span className="post-on mr-10">
                                    25{t("April")}
                ...
                <div className="sidebar-widget widget_tags mb-50">
                    ...
                    <div className="tagcloud">
                        <Link href="/blog-category-grid">
                            <a className="tag-cloud-link">{t("beautiful")}</a>
                        </Link>
                        <Link href="/blog-category-grid">
                            <a className="tag-cloud-link">{t("New York")}</a>
                        </Link>
                        <Link href="/blog-category-grid">
                            <a className="tag-cloud-link">{t("droll")}</a>
                        </Link>
                        <Link href="/blog-category-grid">
                            <a className="tag-cloud-link">{t("intimate")}</a>
                        </Link>
                        <Link href="/blog-category-grid">
                            <a className="tag-cloud-link">{t("loving")}</a>
                        </Link>
                        <Link href="/blog-category-grid">
                            <a className="tag-cloud-link">{t("travel")}</a>
                        </Link>
                        <Link href="/blog-category-grid">
                            <a className="tag-cloud-link">{t("fighting")}</a>
                        </Link>
                    </div>
                </div>
            </div>
